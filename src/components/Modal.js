...
const Modal = ({ isOpen, onClose, title, children }) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="sticky top-0 bg-[#f7f7f5] border-b-2 border-[#2D5016] p-6 flex justify-between items-start">
          <h2 className="text-3xl font-bold text-[#2D5016]">{title}</h2>
          <button
            onClick={onClose}
            className="text-2xl font-bold text-[#2D5016] hover:opacity-60 focus:outline-none focus:ring-2 focus:ring-[#2D5016] px-3"
